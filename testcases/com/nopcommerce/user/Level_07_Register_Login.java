...
public class Level_07_Register_Login extends BaseTest{
	WebDriver driver;
	...
	public void TC_03_MyAccount() {
		...
		myAccountPage.openAddressesPage();
		
		//Addresses ->  Reward Points
		myAccountPage.openRewardPointsPage();
		
		//Reward  Points -> Orders 
		myAccountPage.openOrdersPage();
		
		//Orders  -> CustomerInfor
		myAccountPage.openCustomerInforPage();
	}
